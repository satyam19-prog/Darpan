export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-surface flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md px-4 relative">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400">Track. Compete. Improve.</p>
        </div>
        {children}
      </div>
    </div>

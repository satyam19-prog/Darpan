  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-900 dark:text-white">Camp Management</h1>
              ...
              <Card hover className="h-full">
                ...
                <div className="text-sm text-slate-500 dark:text-slate-400 space-y-2">
                  ...
                  <div className="flex space-x-4 pt-2">
                    <div>
                      <span className="block font-semibold text-slate-900 dark:text-white">{camp._count.enrollments}</span>
                      <span className="text-xs uppercase">Students</span>
                    </div>
                    <div>
                      <span className="block font-semibold text-slate-900 dark:text-white">{camp._count.mentors}</span>
